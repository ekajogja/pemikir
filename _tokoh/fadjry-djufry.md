...
pokok_pikiran: Pertanian Cerdas Iklim (*Climate Smart Agriculture*); modernisasi instrumen dan standarisasi teknologi pertanian; pemodelan tanaman berbasis *thermal unit* untuk adaptasi perubahan iklim di Indonesia.
karya_utama:
  - judul: Teknologi Budidaya Tanaman Adaptatf untuk Pertanian Modern Berkelanjutan
    tahun: 2022
    jenis: Orasi Profesor Riset
  ...
  - judul: "Climate Smart Agriculture: Strategi Menghadapi Perubahan Iklim di Sektor Pertanian"
    ...
    jenis: Buku/Artikel
sumber:
  - url: https://id.wikipedia.org/wiki/Fadjry_Djufry
    label: Wikipedia - Fadjry Djufry
  - url: https://bsip.pertanian.go.id/profil/fadjry-djufry
    label: Profil BSIP - Fadjry Djufry
---
