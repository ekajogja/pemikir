...
pokok_pikiran: "Integrasi ilmu agama dan ilmu umum dalam sistem pendidikan pesantren (Islamisasi Ilmu Pengetahuan) serta penguatan akidah melalui pendekatan teologi klasik dan modern."
karya_utama:
  - judul: "Ilmu Kalam"
    tahun: 1998
    jenis: Buku
  - judul: "Theology Hindu Dharma dan Islam"
    tahun: 1996
    jenis: Buku
  - judul: "Aqidah al-Tawhid 'inda al-Falasifah wa al-Mutakallimin wa al-Sufiyah"
    tahun: 2009
    jenis: Buku
sumber:
  - url: https://gontor.ac.id/
    label: Portal Pondok Modern Darussalam Gontor
  - url: https://unida.gontor.ac.id/
    label: Universitas Darussalam Gontor (Profil Rektor)
---
