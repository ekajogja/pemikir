...
pokok_pikiran: "Penguatan sentralitas Indonesia di Asia Tenggara melalui diplomasi ASEAN serta promosi identitas Indonesia sebagai negara demokrasi dengan penduduk Muslim terbesar di dunia."
karya_utama:
  - judul: "Indonesia in ASEAN: Foreign Policy and Regionalism"
    tahun: 1994
    jenis: Buku
  - judul: "Negotiating Indonesia's Foreign Policy"
    tahun: 2005
    jenis: Buku
  - judul: "Democracy, Islam and the State in Indonesia (Editor)"
    tahun: 2008
    jenis: Buku
sumber:
  - url: https://id.wikipedia.org/wiki/Dewi_Fortuna_Anwar
    label: Wikipedia Indonesia
  - url: https://brin.go.id/
    label: Portal BRIN (Profil Profesor Riset)
---
