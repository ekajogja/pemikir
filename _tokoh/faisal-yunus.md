...
lahir: '1952'
wafat: 
tempat_lahir: Batusangkar, Tanah Datar, Sumatera Barat
afiliasi: Fakultas Kedokteran Universitas Indonesia (FKUI), RSUP Persahabatan
periode: 1980-2026
bidang:
  - Pulmonologi
  - Kedokteran Respirasi
  - Kedokteran Fisik & Rehabilitasi Paru
pendidikan:
...
pokok_pikiran: Standarisasi tata laksana asma dan PPOK (*COPD*) di Indonesia; pelopor rehabilitasi paru berbasis bukti internasional (GINA, GOLD) yang diadaptasi lokal; manajemen kesehatan respirasi komprehensif bagi masyarakat tropis.
karya_utama:
...
sumber:
  - url: https://id.wikipedia.org/wiki/Faisal_Yunus
    label: Wikipedia - Faisal Yunus
  - url: https://id.wikipedia.org/wiki/Faisal_Yunus_(dokter)
    label: Wikipedia - Faisal Yunus (dokter)
  - url: https://fk.ui.ac.id/staf-pengajar/faisal-yunus/
    label: Profil FKUI - Faisal Yunus
---
