...
pokok_pikiran: Mendorong orientasi kebudayaan Indonesia ke arah kemajuan, rasionalitas, dan modernitas (Barat) melalui sastra dan pembaruan tata bahasa Indonesia.
karya_utama:
  - judul: Layar Terkembang
    tahun: 1936
    jenis: Novel
  - judul: Tatabahasa Baru Bahasa Indonesia
    tahun: 1936
    jenis: Buku
  - judul: Polemik Kebudayaan
    tahun: 1948 (Kumpulan Esai)
    jenis: Buku
sumber:
  - url: https://id.wikipedia.org/wiki/Sutan_Takdir_Alisjahbana
    label: Wikipedia – Sutan Takdir Alisjahbana
---
