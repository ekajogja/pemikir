...
pokok_pikiran: Isolasi dan Karakterisasi Senyawa Aktif Tumbuhan Sumatra; Saintifikasi Jamu untuk Obat Modern; Eksplorasi Biodiversitas Hutan Hujan Tropis; Pengembangan Fitofarmaka Berbasis Kearifan Lokal.
karya_utama:
  - judul: Penemuan Senyawa Baru dari Tumbuhan Sumatra (Publikasi Ilmiah)
    tahun: 1985-2020
    jenis: Artikel Jurnal Internasional
  - judul: Phytochemical and Biological Activity of Plants from West Sumatra
    tahun: 1990
    jenis: Laporan Riset
sumber:
  - url: https://scholar.google.co.id/citations?user=vX_v_QIAAAAJ&hl=en
    label: Google Scholar - Dayar Arbain
  - url: https://id.wikipedia.org/wiki/Dayar_Arbain
    label: Wikipedia - Dayar Arbain
---
