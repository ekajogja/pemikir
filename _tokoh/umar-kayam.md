...
pokok_pikiran: "Melakukan dekonstruksi sosiologis terhadap kelas 'Priyayi' serta menganalisis transformasi kebudayaan Jawa di tengah tarikan tradisi dan modernitas global."
karya_utama:
  - judul: "Para Priyayi (Novel)"
    tahun: 1992
    jenis: Buku
  - judul: "Jalan Menikung (Novel)"
    tahun: 1999
    jenis: Buku
  - judul: "Seni, Tradisi, Masyarakat (Kumpulan Esai)"
    tahun: 1981
    jenis: Buku
  - judul: "Mangan Ora Mangan Kumpul (Kumpulan Kolom)"
    tahun: 1990
    jenis: Buku
sumber:
  - url: https://id.wikipedia.org/wiki/Umar_Kayam
    label: "Wikipedia: Umar Kayam"
  - url: https://ensiklopedia.kemdikbud.go.id/sastra/artikel/Umar_Kayam
    label: "Ensiklopedia Sastra Kemdikbud: Umar Kayam"
---
