...
pokok_pikiran: "Integrasi riset molekuler dalam tata laksana penyakit dalam (gastroenterologi) serta pembelaan terhadap independensi institusi pendidikan kedokteran dari intervensi birokrasi non-akademik."
karya_utama:
  - judul: "Apa Kata Dokter (Kumpulan Edukasi Publik)"
    tahun: 2015
    jenis: Buku
  - judul: "Panduan Tatalaksana GERD di Indonesia (Editor)"
    tahun: 2013
    jenis: Panduan Klinis
  - judul: "Integritas Kedokteran di Era Disrupsi"
    tahun: 2020
    jenis: Esai/Artikel
sumber:
  - url: https://id.wikipedia.org/wiki/Ari_Fahrial_Syam
    label: Wikipedia Indonesia
  - url: https://ui.ac.id/
    label: Portal Universitas Indonesia (Profil Dekan)
---
