...
karya_utama:
  - judul: "Harian Merdeka (Pendiri)"
    tahun: 1945
    jenis: Surat Kabar
  - judul: "Angkatan Baru (Pendiri)"
    tahun: 1945
    jenis: Surat Kabar
  - judul: "Naskah Asli Proklamasi (Penyelamat)"
    tahun: 1945
    jenis: Memoar
sumber:
  - url: https://id.wikipedia.org/wiki/B.M._Diah
    label: "Wikipedia: B.M. Diah"
  - url: https://historia.id/politik/articles/b-m-diah-wartawan-penjaga-sejarah-P0p0x
    label: "Historia.id: B.M. Diah, Wartawan Penjaga Sejarah"
---
